...
function handleFetchBtnClick(evt) {
  ...
  switch (node.id) {
    case "btn-anonymous":
      fetchDataAndUpdateUI(URL + "anonymous", false);
      break;
    case "btn-authenticated":
      fetchDataAndUpdateUI(URL + "authenticated", true);
      break;
    case "btn-user":
      fetchDataAndUpdateUI(URL + "reservations", true);
      break;
    case "btn-admin":
      fetchDataAndUpdateUI(URL + "members/admin", true);
      break;
    case "btn-user-admin":
      fetchDataAndUpdateUI(URL + "user-admin", true);
      break;
    case "btn-user-from-token":
      fetchDataAndUpdateUI(URL + "user-fromtoken", true);
      break;
  }
}
